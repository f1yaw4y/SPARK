...
# Default cache TTL in seconds -- must cover MAX_MESSAGE_AGE (600s) to
# prevent replay of packets whose timestamp is still valid but whose
# payload was already processed.
DEFAULT_CACHE_TTL = 660  # 11 minutes (MAX_MESSAGE_AGE + buffer)
